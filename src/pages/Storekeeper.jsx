...
class Storekeeper extends Component {
    ...
    async componentDidMount() {
        ...
        await axios.get('http://localhost:5000/api/storekeeper/login-info', null)
         .then(data => {
        ...
        await axios.get('http://localhost:5000/api/storekeeper/order-reception', null)
         .then(data => {
        ...
        await axios.get('http://localhost:5000/api/storekeeper/order-received', null)
         .then(data => {
    ...
    async handleClick(value){
        ...
        await axios.post('http://localhost:5000/api/storekeeper/order-stored',order_id)
        .then((data)=>{
